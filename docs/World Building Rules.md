...
- After a LAUNCH you nearly always CIRCULARIZE 
- To travel between two Planets you need to do a PLANE CHANGE and then a TRANSFER, but this lets you skip the intervening Star / StarSystem 
- Entering a Planet's sphere of influence after a TRANSFER you'll want to CIRCULARIZE 
...
- If you need to change StarSystems, it's polite to TRANSFER to Solar Orbit around the nearest Star, then use a HYPERSPACE maneuver, but just like a TRANSFER lets you go planet-to-planet, a HYPERSPACE lets you go from star-to-star without ascending up to the intervening StarSystem or Galaxy node(s) 
