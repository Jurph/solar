...
class StarSystem(Location):
    ...
    parent = ForeignKey(Galaxy, on_delete=models.CASCADE)
...
class Station(Location):
    ...
    parent = ForeignKey(Location, on_delete=models.CASADE)
