...
class PhysicalBodySerializer(BaseSerializer):
    ...
    def _get_thermal_properties(self) -> Dict[str, Any]:
        ...
        equilibrium_temperature_k = getattr(self.concrete, 'equilibrium_temperature_k', None)
    ...
    def _get_atmosphere_properties(self, model_class) -> Dict[str, Any]:
        ...
        return {
            ...
            'atmosphere_height_formatted': display.format_atmosphere_height(atmo_data['atmosphere_height_km']),
            'scale_height_km': atmo_data['scale_height_km'],
            'scale_height_formatted': display.format_atmosphere_height(atmo_data['scale_height_km']),
...
class PlanetSerializer(PhysicalBodySerializer):
    ...
    def _get_orbital_properties(self) -> Dict[str, Any]:
        ...
        orbital_inclination_deg = getattr(self.concrete, 'orbital_inclination_deg', None)
        ...
        return {
            ...
            'orbital_eccentricity_formatted': (
                f"{orbital_eccentricity:.3f}" if orbital_eccentricity is not None else 'N/A'
            ),
            'orbital_inclination_deg': orbital_inclination_deg,
            'orbital_inclination_formatted': (
                f"{orbital_inclination_deg:.2f}°" if orbital_inclination_deg is not None else 'N/A'
            ),
        }
